...
class Device {
  ...
  assemble(properties) {
    ...
    if(self.spatems.length > 0) {
      // TODO: property filtering?
      device.spatem = Object.assign({}, self.spatems[0]);
      delete device.spatem.deviceId;
      delete device.spatem.deviceIdType;
    }
